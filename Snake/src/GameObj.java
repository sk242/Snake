...
public abstract class GameObj {
    ...
    /*
     * Size of object, in pixels. @Override
     */
    private int width;
    private int height;
    ...
    public boolean intersects(GameObj that) {
        return (this.px + this.width >= that.px && this.py + this.height >= that.py && that.px + 
                that.width >= this.px
    ...
    /**
     * Determine whether the game object is hitting a wall
     * 
     */
    public boolean hitWall() {
        return (this.px == 0) || (this.px == maxX + width) || (this.py == 0) || (this.py == maxY 
                + height);
    }
